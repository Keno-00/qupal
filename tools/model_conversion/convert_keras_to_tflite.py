...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Convert a Keras .h5/.keras model to TFLite.')
    parser.add_argument('--model', required=True, help='Path to .h5 or .keras model file')
